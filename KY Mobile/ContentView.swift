...
//  kymaryam
//
//  Created by Maryam Safiyah Widad Mohd Azmi on 12/01/2021.
//
...
//                                                    Firestore.firestore().collection("ratings").document("\(self.rating_id)").delete() { err in
//                                                        if let err = err {
...
//                    self.reviewedRestaurants.append(Restaurant(id: UUID(uuidString: documents[i].documentID) ?? UUID(),
